...
import type { IGrammarRepository } from "./grammar";
import type { IRawGrammar, IRawRule } from "../rawGrammar";
import type { ScopeName } from "../theme";
...
function collectExternalReferencesInRules(
    ...
    for (const rule of rules) {
        ...
        switch (reference.kind) {
            ...
            case IncludeReferenceKind.TopLevelRepositoryReference: { const selfGrammar
            ...
            } else if (reference.kind === IncludeReferenceKind.TopLevelRepositoryReference) {
