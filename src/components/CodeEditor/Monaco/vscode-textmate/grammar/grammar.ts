...
import { EncodedTokenAttributes, StandardTokenType, toOptionalTokenType } from "../encodedTokenAttributes";
import type { IEmbeddedLanguagesMap, IGrammar, IToken, ITokenizeLineResult, ITokenizeLineResult2, ITokenTypeMap, StateStack } from "../main";
import { createMatchers, type Matcher } from "../matcher";
import { disposeOnigString, type IOnigLib, type OnigScanner, type OnigString } from "../onigLib";
import type { IRawGrammar, IRawRepository, IRawRule } from "../rawGrammar";
import { type IRuleFactoryHelper, type IRuleRegistry, Rule, RuleFactory, type RuleId, ruleIdFromNumber, ruleIdToNumber } from "../rule";
import { FontStyle, type ScopeName, type ScopePath, ScopeStack, StyleAttributes } from "../theme";
...
export class StateStackImpl implements StateStack {
    ...
    public withContentNameScopesList(contentNameScopeStack: AttributedScopeStack): StateStackImpl {
