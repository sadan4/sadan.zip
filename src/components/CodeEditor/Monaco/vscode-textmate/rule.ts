...
import { FindOption, type IOnigCaptureIndex, type IOnigLib, type OnigScanner, type OnigString } from "./onigLib";
import type { ILocation, IRawCaptures, IRawGrammar, IRawRepository, IRawRule } from "./rawGrammar";
import { basename, escapeRegExpCharacters, mergeObjects, type OrMask, RegexSource } from "./utils";
...
export class CaptureRule extends Rule {
    ...
    public compile(_grammar: IRuleRegistry & IOnigLib, _endRegexSource: string): CompiledRule {
        throw new Error("Not supported!");
    }

    public compileAG(_grammar: IRuleRegistry & IOnigLib, _endRegexSource: string, _allowA: boolean, _allowG: boolean): CompiledRule {
        throw new Error("Not supported!");
    }
}
...
export class MatchRule extends Rule {
    ...
    public compile(grammar: IRuleRegistry & IOnigLib, _endRegexSource: string): CompiledRule {
        return this._getCachedCompiledPatterns(grammar).compile(grammar);
    }

    public compileAG(grammar: IRuleRegistry & IOnigLib, _endRegexSource: string, allowA: boolean, allowG: boolean): CompiledRule {
...
export class BeginWhileRule extends Rule {
    ...
    private _getCachedCompiledWhilePatterns(_grammar: IRuleRegistry & IOnigLib, endRegexSource: string | null): RegExpSourceList<RuleId | typeof whileRuleId> {
        if (!this._cachedCompiledWhilePatterns) {
