...
import { BalancedBracketSelectors, createGrammar, Grammar, type IGrammarRepository, type IThemeProvider } from "./grammar";
import type { IEmbeddedLanguagesMap, IGrammar, ITokenTypeMap } from "./main";
import type { IOnigLib } from "./onigLib";
import type { IRawGrammar } from "./rawGrammar";
import { type ScopeName, ScopeStack, StyleAttributes, Theme } from "./theme";
