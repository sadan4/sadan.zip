...
import { applyStateStackDiff, diffStateStacksRefEq, type StackDiff } from "./diffStateStacks";
...
import { type IRawTheme, type ScopeName, Theme } from "./theme";

export * from "./onigLib";

export type {
    IRawGrammar, IRawTheme,
};
...
export {
    applyStateStackDiff, diffStateStacksRefEq,
};
export type {
    StackDiff,
};
