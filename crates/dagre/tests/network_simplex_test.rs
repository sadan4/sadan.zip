...
use dagre::graph::{Edge, Graph, GraphOpts};
use dagre::rank::feasible_tree::{Tree, TreeEdge, TreeNode};
use dagre::rank::network_simplex;
use dagre::rank::util_rank::longest_path;
use dagre::types::{EdgeLabel, GraphLabel, NodeLabel};
use dagre::util::normalize_ranks;
...
fn gansner_tree() -> Tree {
    ...
    for (v, w) in [("a", "b"), ("b", "c"), ("c", "d"), ("d", "h"), ("h", "g"), ("g", "e"), ("g", "f")] {
        if !t.has_node(v) {
