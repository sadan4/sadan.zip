// Webpack Module 100527 - Patched by
// NOTE: pretty sure this is a namespace in source, not an enum, but it's used the same way so who cares
0,
function(e, t, n) {
    "use strict";
    n.d(t, {
    ...
    var r = function(e) {
        return e.QUICK_SWITCHER = "quick switcher",
        ...
        e.GUILD_POWERUPS_COACHMARK_GAME_SERVER_HOSTING_AVAILABLE = "guild powerups - coachmark - game server hosting available",
        ...
        e.SLAYER_STOREFRONT_PRODUCT_DETAILS_MODAL_PURCHASE_BUTTON = "slayer storefront product details modal purchase button",
        e.SLAYER_STOREFRONT_PRODUCT_DETAILS_MODAL_GIFT_BUTTON = "slayer storefront product details modal gift button",
        e.SLAYER_STOREFRONT_PRODUCT_DETAILS_EMBED_PURCHASE_BUTTON = "slayer storefront product details embed purchase button",
        ...
        e.SLAYER_STOREFRONT_BREADCRUMB_WISHLIST_ITEM_CARD_GIFT_BUTTON = "slayer storefront breadcrumb wishlist item card gift button",
