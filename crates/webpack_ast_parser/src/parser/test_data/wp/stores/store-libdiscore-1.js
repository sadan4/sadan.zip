...
function(e, t, n) {
    ...
    class E extends o.yW {
        ...
        constructor(...e) {
            ...
            p(this, "getGuild", e => {
                if (null != e)
                    return e === d.YYv ? f._ : this.database.get(e)
            }
            ),
            p(this, "getGuilds", this.database.memoized(e => _({}, e))),
            p(this, "getGuildsArray", this.database.memoized(e => Object.values(e))),
            p(this, "getGuildIds", this.database.memoized(e => c.default.keys(e)))
        }
    }
