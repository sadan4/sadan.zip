// Webpack Module 34337 - Patched by ContextMenuAPI, CopyFileContents, ShikiCodeblocks, VoiceMessages
0,
function(e, t, n) {
    "use strict";
    n.d(t, {
    ...
    var i, r = n(627968), s = n(64700), a = n(503698), o = n.n(a), l = n(735438), u = n.n(l), c = n(621466), d = n(17928), _ = n(922016), h = n(187322), f = n(834730), p = n(821609), E = n(289873), m = n(939249), g = n(582394), A = n(306788), I = n(534514), T = n(789645), S = n(364522), y = n(493336), C = n(334738), N = n(192308), v = n(267102), R = n(619517), O = n(256905), b = n(536763), D = n(218394);
    class L extends s.PureComponent {
        ...
        ;
        modalContext = (0,
        N.modalContextFromAppContext)(this.props.appContext);
        onCloseImage = () => {
            (0,
            N.closeModal)(O.K, this.modalContext)
        }
        ;
        onZoom = (e, t) => {
            let {zoomThumbnailPlaceholder: n, trigger: i} = t;
            e.preventDefault();
            let {alt: r, src: s, original: a, width: o, height: l, animated: u, srcIsAnimated: d, children: _, shouldHideMediaOptions: h=!1, sourceMetadata: f, analyticsSource: p, contentType: E, originalContentType: m} = this.props;
            (0,
            c.vq)(e.currentTarget) && e.currentTarget.blur(),
            (0,
            O.R)({
    ...
    class j extends s.PureComponent {
        render() {
            let {src: e, fileSize: t, fileName: n, className: i, playable: s, volume: a, renderLinkComponent: o, onVolumeChange: l, onVolumeShow: u, onVolumeHide: c, autoMute: d, onMute: _, mimeType: h, onPlay: f} = this.props;
            return (0,
            r.jsx)(B.Ay, {
                src: e,
                fileName: n,
    ...
    var H = n(248643)
      ...
      , e_ = n(429128);
    function eh(e) {
        return Vencord.Plugins.plugins["ShikiCodeblocks"].renderHighlighter({
            lang: e.language,
            content: e.text
        });
            ...
            r.jsx)(eo.l, {
                ...
                r.jsx)(Y.c2, {
                    ...
                    render: e => {
                        ...
                        return null == n ? a() : (0,
                        r.jsx)("code", {
                            className: o()(e_.kw, ed.Xb, "hljs", n.language, {
                                [ed.Zw]: s
                            }),
    ...
    function ef(e) {
        let {expanded: t, setExpanded: n, numLines: i, isWholeFile: s} = e
          , a = ec.intl.formatToPlainString(s ? ec.t.Go5Vvs : ec.t.yJcYan, {
            lines: i
        })
                ...
                r.jsx)(q.l, {
                    ...
                    r.jsx)("div", {
                        ...
                        r.jsxs)(Z.iS, {
                            ...
                            children: [(0,
                            r.jsx)(Z.a3, {
                                placeholder: ec.intl.string(ec.t.GofftW)
                            }), (0,
                            r.jsx)(Z.X2, {})]
                        })
                    })
    ...
    function eA(e) {
        let {url: t, fileName: n, fileSize: i, fileContents: s, expanded: a, setExpanded: l, language: u, setLanguage: c, wordWrap: d, setWordWrap: _, bytesLeft: h, className: f} = e
          , p = s?.split("\n")
          , m = p?.length ?? 0
          , g = a ? 100 : 6
          , A = 0 === h
          , I = "";
        A && a && m > g ? I = "\n..." : A || (I = "..."),
        "" !== I && (A ? I += " " + ec.intl.formatToPlainString(ec.t.DQnFp2, {
            lines: m - g
        }) : I += " " + ec.intl.formatToPlainString(ec.t["1+gGcK"], {
            formattedBytes: (0,
            eu.up)(h)
        }));
        ...
        r.jsxs)("div", {
            ...
            r.jsxs)("div", {
                ...
                r.jsx)(eg, {
                    ...
                    fileContents: s,
                    bytesLeft: h
                }) : null, Vencord.Plugins.plugins["CopyFileContents"].addCopyButton({
                    fileContents: s,
                    bytesLeft: h
                }), (0,
                r.jsx)(em, {
    ...
    function eI(e) {
        let {url: t, fileName: n, fileSize: i, transitionState: a, language: o, wordWrap: l, fileContents: u, bytesLeft: d, onClose: _} = e
          , [h,p] = s.useState(o)
          , [m,g] = s.useState(l)
          , A = s.useRef(null)
          , I = u ?? "";
        return 0 !== d && (I += `... ${ec.intl.formatToPlainString(ec.t["1+gGcK"], {
            formattedBytes: (0,
            eu.up)(d)
        })}`),
        s.useEffect( () => {
            function e(e) {
                if ((e.metaKey || e.ctrlKey) && "a" === e.key && null != A.current) {
                    ...
                    if ((0,
                    c.vq)(t, HTMLInputElement) || (0,
                    c.vq)(t, HTMLTextAreaElement))
                        return;
                    e.preventDefault();
                ...
                r.jsx)("div", {
                    ...
                    r.jsxs)(f.E, {
                        ...
                        r.jsx)(eE, {
                            ...
                            setLanguage: p,
                            align: "bottom"
                        }), Vencord.Plugins.plugins["CopyFileContents"].addCopyButton(arguments[0]), (0,
                        r.jsx)(em, {
                            wordWrap: m,
                            setWordWrap: g,
                            url: t,
    ...
    let eT = s.memo(function(e) {
        let {url: t, fileName: n, fileSize: i, contentType: a, className: l, onClick: u, onContextMenu: c} = e
          ...
          , [p,E] = s.useState(!1)
          , {fileContents: m, bytesLeft: g, hadError: A} = function(e, t) {
    ...
    eU.A)(function(e) {
      ...
      , eB = e => {
        ...
        if (o < i)
            return null;
        let c = u()(n).filter(eG.Vq).take(s).map(e => (0,
        r.jsx)(eV, {
            member: e,
            guildId: a
        }, e.id)).value()
    ...
    function ez(e) {
        let {summary: t, channel: i, members: a, guildId: o, unread: l, onClick: u} = e
          , [c,_] = s.useState(!1)
          , h = (0,
        eO.aK)(eM.default.extractTimestamp(t.startId))
          , p = (0,
        d.bG)([ey.A], () => ey.A.summaryFeedback(t));
        function E(e, n) {
            e.stopPropagation(),
            (0,
            eP.A)({
    ...
    function eq(e) {
        let {summaries: t, summariesMembers: n, channel: i, selectTopic: a, setOpen: o} = e
          , l = (0,
        d.bG)([eD.Ay], () => eD.Ay.getOldestUnreadMessageId(i.id))
          , u = s.useCallback(e => {
            a(e),
            o(!1)
        }
    ...
    class ts {
        ...
        getCurrentValue() {
            ...
            return e > t ? (this.animationDetails = null,
            this.value) : this.value < this.animationDetails.lastValue ? tr.easeOutQuint(e, this.animationDetails.lastValue, this.value, t) : tr.easeOutBack(e, this.animationDetails.lastValue, this.value, t, 4)
        }
        animateTo(e) {
            this.isReset = !1,
            this.value !== e && (this.animationDetails = {
    ...
    function th(e) {
        let t, n, {className: i, waveform: a, currentTime: l, duration: u, played: c, playing: d, onDrag: _, onDragStart: h, onDragEnd: f} = e, {ref: p, width: E} = (0,
        e9.Ay)(), m = s.useMemo( () => 6 * Math.floor(((u <= .5 ? 40 : u >= 45 ? 294 : (Math.min(u, 45) - .5) / 44.5 * 254 + 40) + 4) / 6) - 4, [u]), g = s.useRef(void 0), A = (t = s.useMemo( () => (function(e) {
            let t;
            if (null == e)
                return;
            try {
            ...
            for (let e = 0; e < t.length; e++)
                n[e] = t.charCodeAt(e) / 255;
            return n
        }
        )(a), [a]),
        n = s.useMemo( () => (function(e) {
            if (null != e)
        ...
        s.useMemo( () => (function(e, t) {
            if (null != e && null != t) {
                ...
                return function(e, t) {
                    if (ti()(e.length >= t, "Waveform smaller than samples"),
                    e.length === t)
                        return e;
                    let n = e.length / t
                      , i = []
        ...
        )(t ?? [], n) ?? tl, [t, n])), I = s.useRef(c), T = s.useRef(d), S = s.useRef(null), y = window.devicePixelRatio, {lastBackgroundFillColor: C, backgroundFillColor: N, lastActiveFillColor: v, activeFillColor: R, lastInactiveFillColor: O, inactiveFillColor: b} = function(e, t) {
            let n = (0,
            e8.r)(e7.A.colors.BACKGROUND_MOD_MUTED).hex()
              , i = (0,
            e8.r)(e7.A.colors.INTERACTIVE_TEXT_DEFAULT).hex()
              , r = (0,
            e8.r)(e7.A.colors.INTERACTIVE_TEXT_ACTIVE).hex()
              , s = (0,
            e8.r)(e7.A.unsafe_rawColors.BRAND_430).hex()
              , a = (0,
            e8.r)(e7.A.unsafe_rawColors.WHITE).hex()
              , o = t ? s : n
              , [l,u] = td(o, t, e)
        ...
        s.useEffect( () => {
            ...
            return e = requestAnimationFrame(function t(n) {
                ...
                if (null == i || null == r || null == s)
                    return;
                let a = !1;
                (I.current !== c || T.current !== d) && (I.current = c,
                T.current = d,
                S.current = n),
                ...
                for (let e = 0; e < s.length; e++) {
                    let t = s[e]
                      , n = Math.max(t.getCurrentValue(), A[e] - .1);
                    r.beginPath(),
    ...
    let tm = Vencord.Plugins.plugins["VoiceMessages"].VoiceMessage = s.memo(function(e) {
        let t, {src: n, volume: i=1, onVolumeChange: a, onMute: l, waveform: u, durationSecs: c, onVolumeShow: _, onVolumeHide: h, onPlay: p, onPause: E, onError: g, playbackCacheKey: A} = e, I = s.useRef(null), T = s.useMemo( () => null != A ? e1.Ay.getPlaybackPosition(A) : 0, [A]), S = (0,
        d.bG)([e1.Ay], () => e1.Ay.getPlaybackRate(e1.k0.VOICE_MESSAGE)), [y,C] = s.useState(T > 0), [N,v] = s.useState(T), [R,O] = s.useState(c), [b,D] = s.useState(!1), [L,w] = s.useState(!1), [M,P] = s.useState(!1), [x,k] = s.useState(!1), [U,G] = s.useState("none"), [F,V] = s.useState( () => "function" == typeof i ? i() : i), B = s.useRef(void 0), j = s.useCallback( () => {
            w(e => !e),
            k(!0)
        }
        , []), H = s.useCallback( () => {
        ...
        , [A, c]), K = s.useCallback( () => {
            w(!1),
            null == B.current && (B.current = setTimeout( () => {
                C(!1),
                k(!1),
                B.current = void 0
            }
        ...
        s.useEffect( () => {
            ...
            if (e || L)
                if (L)
                    et.current = performance.now(),
                    i?.(!1, t, (I.current?.duration ?? 0) * e4.A.Millis.SECOND);
                else {
                    let e = performance.now()
                      , i = et.current;
                    n?.(t, null != i ? (e - i) / 1e3 : 0),
                    W(t),
                    et.current = null
                }
        }
        ...
        s.useEffect( () => {
            if (L)
                return e6._.dispatch(eW.jej.VOICE_MESSAGE_PLAYBACK_STARTED, {
                    src: n
                }),
        ...
        let er = L ? eX.E : eQ.u
          ...
          , ea = ec.intl.formatToPlainString(ec.t.LgCPMt, {
            playbackRate: S
        })
          , eo = `${S.toString().replace(/^0/, "")}X`;
        t = "Safari" === platform.name ? (0,
        r.jsx)(s.Suspense, {
            children: (0,
            r.jsx)(tp, {
                ref: I,
        ...
        let el = (0,
        d.bG)([eJ.Ay], () => eJ.Ay.useReducedMotion);
        return (0,
        r.jsxs)("div", {
            className: o()(tf.kL, {
                [tf.he]: L
            ...
            r.jsx)(m.D, {
                ...
                onClick: () => {
                    var e, t;
                    let n;
                    return n = (ta.indexOf(S) + 1) % ta.length,
                    void (e = ta[n],
    ...
    function tD(e) {
        let {alt: t, controlsVisible: n=!0, disableAltTextDisplay: i=!1, hiddenSpoilers: a=!1, reducedSizeAltTextButton: l=!1} = e
          , [u,c] = s.useState(!1)
          , d = s.useRef(null);
        return (n || u) && !i && eZ._z.getSetting() && null != t && "" !== t && !0 !== a ? (0,
        r.jsx)("div", {
            className: tN.NO,
            children: (0,
            r.jsx)(_.Y, {
    ...
    function tL(e) {
        let {onVolumeChange: t, onMute: n, volume: i, autoMute: a, alt: o, renderAdjacentContent: l, renderOverlayContent: u, disableAltTextDisplay: c=!1, hiddenSpoilers: d, mosaicStyleAlt: _, mediaLayoutType: h, reducedSizeAltTextButton: p, ...E} = e
          , m = tR(t)
          , g = tO(n);
        i = null == i ? tT.v1 : i,
        a = null == a ? tT.uj : a;
    ...
    function tM(e) {
        let {onVolumeChange: t, volume: n, onMute: i, onVolumeShow: a, onVolumeHide: o, renderAdjacentContent: l, ...u} = e
          , c = tR(t)
          , d = tO(i);
        return n = null == n ? tT.v1 : n,
        (0,
        r.jsxs)(s.Fragment, {
            children: [(0,
            r.jsx)(j, {
    ...
    function tx(e) {
        let {alt: t, hiddenSpoilers: n, renderAdjacentContent: i, containerClassName: a, imageContainerClassName: l, disableAltTextDisplay: u=!1, reducedSizeAltTextButton: c=!1, mediaLayoutType: d, imageContainerStyle: p, mosaicStyleAlt: E} = e
    ...
    var tF = ((i = {})[i.OLD_MESSAGES = 0] = "OLD_MESSAGES",
    i[i.REPLY = 1] = "REPLY",
    i);
    let tV = e => {
        ...
        return (0,
        r.jsx)(U.Y.Consumer, {
            children: e => e.disableInteractions ? null : (0,
            r.jsxs)("div", {
                onClick: n,
                className: o()(tN.Sg, i),
                children: [(0,
    ...
    function tB(e) {
        ...
        r.jsx)(U.Y.Consumer, {
            ...
            r.jsxs)(m.D, {
                ...
                r.jsx)("div", {
                    className: tN.$I,
                    children: ec.intl.string(ec.t["1zUvlw"])
                }), n ? (0,
                r.jsx)(E.y, {
                    type: E.y.Type.PULSING_ELLIPSIS,
                    className: tN.u1,
    ...
    function tj(e) {
        let {content: t, channelId: n} = e
          , [i] = s.useState( () => (0,
        G.Ld)("NewMessagesBarJumpToNewMessages_"))
          , a = s.useCallback( () => {
            let e = eD.Ay.ackMessageId(n);
            null != e ? y.A.jumpToMessage({
                channelId: n,
                messageId: e,
                offset: 1,
            ...
            r.jsx)(h.vN, {
                ...
                r.jsx)("div", {
                    ...
                    r.jsxs)("button", {
                        ...
                        r.jsx)("span", {
                            className: tN.vE,
                            children: ec.intl.string(ec.t.e6RscS)
                        }), (0,
                        r.jsx)(g.M, {
                            size: "md",
                            color: "currentColor",
    ...
    function tH(e) {
        let {channel: t, content: n, scrollManager: i} = e
          ...
          , N = s.useRef(null)
          , v = (0,
        d.yK)([ey.A], () => ey.A.summaries(t.id) ?? [], [t])
          , R = (0,
        x.A)(v);
        s.useEffect( () => {
            u().isEqual(R, v) || tI.default.track(eW.HAw.SUMMARIES_TOPICS_PILL_VIEWED, {
        ...
        let O = (0,
        d.bG)([tg.default], () => v?.map(e => e.people?.map(e => tg.default.getUser(e) ?? null).filter(eG.Vq)) ?? [], [v], tY)
          , b = (0,
        d.bG)([ey.A], () => ey.A.visibleSummaryIndex()) ?? -1
          , D = v?.[b]?.topic;
        null == D && null == l && v?.length >= 1 && (D = v[0]?.topic);
        let L = s.useMemo( () => u().debounce(e => {
            _(e?.id ?? null)
        }
        , 64), [_])
          , w = s.useMemo( () => u().throttle( () => {
            (0,
            eS.C6)(null)
        }
        , 1200, {
        ...
        let H = s.useCallback(e => {
            (0,
            c.vq)(e.target) && h.current?.contains(e.target) || (k && tI.default.track(eW.HAw.SUMMARIES_TOPICS_PILL_TOGGLED, {
        ...
        , [k, v, t, j]);
        s.useEffect( () => (i.addAutomaticAnchorCallback(M),
        () => {
            i.removeAutomaticAnchorCallback(M)
        }
        ), [i, M]),
        ...
        , [t.id]),
        s.useEffect( () => (document.addEventListener("mousedown", H),
        () => {
        ...
        return v.length > 0 && ($ = "" === D || null == D ? ec.intl.string(ec.t.DwnFuG) : D),
        a ? null : (0,
        r.jsxs)("div", {
            ref: h,
    ...
    function tW(e) {
        ...
        x.A)(g);
        s.useEffect( () => {
            u().isEqual(C, g) || tI.default.track(eW.HAw.SUMMARIES_TOPICS_PILL_VIEWED, {
        ...
        let N = (0,
        d.bG)([tg.default], () => g?.map(e => e.people?.map(e => tg.default.getUser(e) ?? null).filter(eG.Vq)) ?? [], [g], tY)
          , v = (0,
        d.bG)([ey.A], () => ey.A.visibleSummaryIndex()) ?? -1
          , R = g?.[v]?.topic;
        ...
        let O = s.useMemo( () => u().get(g, v - 1), [v, g])
          ...
          , D = s.useMemo( () => u().debounce(e => {
            l(e?.id ?? null)
        }
        , 64), [l])
          , L = s.useMemo( () => u().throttle( () => {
            (0,
            eS.C6)(null)
        }
        , 1200, {
        ...
        let Y = s.useCallback(e => {
            (0,
            c.vq)(e.target) && _.current?.contains(e.target) || (M && tI.default.track(eW.HAw.SUMMARIES_TOPICS_PILL_TOGGLED, {
                topics_dropdown_open: !1,
                num_summaries: g.length,
                message_counts: g.map(e => e.count),
                start_message_ids: g.map(e => e.startId),
        ...
        , [M, g, t, H]);
        s.useEffect( () => (n.addAutomaticAnchorCallback(w),
        () => {
            n.removeAutomaticAnchorCallback(w)
        }
        ), [n, w]),
        ...
        , [t.id]),
        s.useEffect( () => (document.addEventListener("mousedown", Y),
        () => {
        ...
        if (!(0,
        d.bG)([ey.A], () => ey.A.shouldShowTopicsBar()))
            return null;
        let K = ec.intl.string(ec.t["38qwgO"]);
        return g.length > 0 && (K = "" === R || null == R ? ec.intl.string(ec.t.DwnFuG) : R),
        i ? null : (0,
        r.jsxs)("div", {
            ref: _,
...
//# sourceURL=file:///WebpackModule34337
