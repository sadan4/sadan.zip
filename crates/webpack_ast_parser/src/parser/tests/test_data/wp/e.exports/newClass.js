// TODO: add support for going to the props in this file
// Webpack Module 61090 - Patched by
0,
function(e, t, n) {
    "use strict";n.d(t, {
        A: () => a
    ...
    class s {
        ...
        prefix = "";
        get isTracing() {
            return !!r && !!this.isTracing_ && (!(Date.now() > this.endTime_) || (this.isTracing_ = !1,
            !1))
        }
        get endTime() {
        ...
        addImportLogDetail() {
            let e = i();
            e - this.lastImportDuration > 25 && (this.addDetail("JS Imports", Math.ceil(e) + "ms"),
